...
const fetchItem = async () => {
  ...
  try {
    ...
    jenjang_pendidikan.value = getData.jenjang_pendidikan;
    jenis_lembaga.value = getData.jenis_lembaga;
    items.value.forEach((e) => {
      ...
      const rwp = [];
      if (e.rwy_pend_formal.length > 0) {
        e.rwy_pend_formal.forEach((r) => {
          rwp.push({
            jenjang_pendidikan_id: r.jenjang_pendidikan_id,
            satuan_pendidikan_formal: r.satuan_pendidikan_formal,
            tahun_masuk: r.tahun_masuk,
            tahun_lulus: r.tahun_lulus,
            ipk: r.ipk,
          });
        });
        form.value.rwy_pend_formal[e.ptk_id] = rwp;
      } else {
        form.value.rwy_pend_formal[e.ptk_id] = {
          jenjang_pendidikan_id: null,
          satuan_pendidikan_formal: null,
          tahun_masuk: null,
          tahun_lulus: null,
          ipk: null,
        };
      }
      if (e.rwy_kerja.length > 0) {
        const rwk = [];
        e.rwy_kerja.forEach((r) => {
          rwk.push({
            jenjang_pendidikan_id: r.jenjang_pendidikan_id,
            jenis_lembaga_id: r.jenis_lembaga_id,
            status_kepegawaian_id: r.status_kepegawaian_id,
            jenis_ptk_id: r.jenis_ptk_id,
            no_sk_kerja: r.no_sk_kerja,
            tgl_sk_kerja: r.tgl_sk_kerja,
            tempat_kerja: r.tempat_kerja,
            mapel_diajarkan: r.mapel_diajarkan,
          });
        });
        form.value.rwy_kerja[e.ptk_id] = rwk;
      } else {
        form.value.rwy_kerja[e.ptk_id] = {
          jenjang_pendidikan_id: null,
...
const simpanRwyPend = async (ptk) => {
  console.log(form.value.rwy_pend_formal[ptk.ptk_id]);
  loadings.value[ptk.ptk_id] = true;
  await $api("/rwy-pend", {
    method: "POST",
    body: {
      ptk_id: ptk.ptk_id,
      rwy_pend_formal: form.value.rwy_pend_formal[ptk.ptk_id],
    },
    async onResponse() {
      loadings.value[ptk.ptk_id] = false;
      isSnackbarTopEndVisible.value = true;
...
const simpanRwyKerja = async (ptk) => {
  console.log(form.value.rwy_kerja[ptk.ptk_id]);
  loadings.value[ptk.ptk_id] = true;
  await $api("/rwy-kerja", {
    method: "POST",
    body: {
      ptk_id: ptk.ptk_id,
      rwy_kerja: form.value.rwy_kerja[ptk.ptk_id],
    },
    async onResponse() {
      loadings.value[ptk.ptk_id] = false;
      isSnackbarTopEndVisible.value = true;
          ...
          <tr>
            <td colspan="5">
              <VTabs v-model="currentTab[item.ptk_id]" grow stacked>
                ...
                <VTab>
                  <VIcon icon="tabler-school" class="mb-2" />
                  <span>Rwy Pend</span>
                </VTab>
                <VTab>
                  <VIcon icon="tabler-ballpen" class="mb-2" />
                  <span>Rwy Karir</span>
                </VTab>
              </VTabs>
              <VWindow v-model="currentTab[item.ptk_id]">
                ...
                <VWindowItem :value="`${item.ptk_id}`">
                  <VTable class="mb-4">
                    ...
                    <tbody>
                      <template v-if="item.rwy_pend_formal.length">
                        <tr
                          v-for="(tambahan, index) in item.rwy_pend_formal"
                          :key="tambahan.riwayat_pendidikan_formal_id"
                        >
                          <td>
                            <AppAutocomplete
                              v-model="
                                form.rwy_pend_formal[item.ptk_id][index]
                                  .jenjang_pendidikan_id
                              "
                              :items="jenjang_pendidikan"
                              placeholder="== Pilih Jenjang =="
                              item-title="nama"
                              item-value="jenjang_pendidikan_id"
                            />
                          </td>
                          <td>
                            <AppTextField
                          ...
                          <td>
                            <AppTextField
                              v-model="
                                form.rwy_pend_formal[item.ptk_id][index].tahun_masuk
                              "
                          ...
                          <td>
                            <AppTextField
                              v-model="
                                form.rwy_pend_formal[item.ptk_id][index].tahun_lulus
                              "
                          ...
                          <td>
                            <AppTextField
                              v-model="form.rwy_pend_formal[item.ptk_id][index].ipk"
                              placeholder="Nilai"
                            />
                          </td>
                          <td class="text-center">
                      ...
                      <template v-else>
                        ...
                        <tr>
                          <td>
                            <AppAutocomplete
                              v-model="
                                form.rwy_pend_formal[item.ptk_id].jenjang_pendidikan_id
                              "
                              :items="jenjang_pendidikan"
                              placeholder="== Pilih Jenjang =="
                              item-title="nama"
                          ...
                          <td>
                            <AppTextField
                              v-model="
                                form.rwy_pend_formal[item.ptk_id].satuan_pendidikan_formal
                              "
                              placeholder="Nama SP"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_pend_formal[item.ptk_id].tahun_masuk"
                              placeholder="Thn Masuk"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_pend_formal[item.ptk_id].tahun_lulus"
                              placeholder="Thn Keluar"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_pend_formal[item.ptk_id].ipk"
                              placeholder="Nilai"
                            />
                          </td>
                          <td class="text-center">
                ...
                <VWindowItem :value="`${item.ptk_id}`">
                  <VTable class="mb-4">
                    ...
                    <tbody>
                      <template v-if="item.rwy_kerja.length">
                        <tr
                          v-for="(tambahan, index) in item.rwy_kerja"
                          :key="tambahan.rwy_kerja_id"
                        >
                          <td>
                            <AppAutocomplete
                              v-model="
                                form.rwy_kerja[item.ptk_id][index].jenjang_pendidikan_id
                              "
                              :items="jenjang_pendidikan"
                              placeholder="== Pilih Jenjang =="
                              item-title="nama"
                          ...
                          <td>
                            <AppAutocomplete
                              v-model="
                                form.rwy_kerja[item.ptk_id][index].jenis_lembaga_id
                              "
                              :items="jenis_lembaga"
                              placeholder="== Pilih Jenis =="
                              item-title="nama"
                              item-value="jenis_lembaga_id"
                            />
                          </td>
                          <td>
                            <AppAutocomplete
                              v-model="form.rwy_kerja[item.ptk_id][index].jenis_ptk_id"
                              :items="jenis_ptk"
                              placeholder="== Pilih Jenis PTK =="
                              item-title="jenis_ptk"
                              item-value="jenis_ptk_id"
                          ...
                          <td>
                            <AppAutocomplete
                              v-model="
                                form.rwy_kerja[item.ptk_id][index].status_kepegawaian_id
                              "
                              :items="status_kepegawaian"
                              placeholder="== Pilih Status =="
                              item-title="nama"
                          ...
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id][index].no_sk_kerja"
                              placeholder="No SK Kerja"
                            />
                          </td>
                          <td>
                            <AppDateTimePicker
                              v-model="form.rwy_kerja[item.ptk_id][index].tgl_sk_kerja"
                              placeholder="== Pilih Tanggal =="
                              :config="dateConfig"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id][index].mapel_diajarkan"
                              placeholder="Mapel"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id][index].tempat_kerja"
                              placeholder="Tempat"
                            />
                          </td>
                          <td class="text-center">
                      ...
                      <template v-else>
                        ...
                        <tr>
                          <td>
                            <AppAutocomplete
                              v-model="form.rwy_kerja[item.ptk_id].jenjang_pendidikan_id"
                              :items="jenjang_pendidikan"
                              placeholder="== Pilih Jenjang =="
                              item-title="nama"
                              item-value="jenjang_pendidikan_id"
                          ...
                          <td>
                            <AppAutocomplete
                              v-model="form.rwy_kerja[item.ptk_id].jenis_lembaga_id"
                              :items="jenis_lembaga"
                              placeholder="== Pilih Jenis =="
                              item-title="nama"
                              item-value="jenis_lembaga_id"
                          ...
                          <td>
                            <AppAutocomplete
                              v-model="form.rwy_kerja[item.ptk_id].jenis_ptk_id"
                              :items="jenis_ptk"
                              placeholder="== Pilih Jenis PTK =="
                              item-title="jenis_ptk"
                              item-value="jenis_ptk_id"
                          ...
                          <td>
                            <AppAutocomplete
                              v-model="form.rwy_kerja[item.ptk_id].status_kepegawaian_id"
                              :items="status_kepegawaian"
                              placeholder="== Pilih Status =="
                              item-title="nama"
                              item-value="status_kepegawaian_id"
                          ...
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id].no_sk_kerja"
                              placeholder="No SK Kerja"
                            />
                          </td>
                          <td>
                            <AppDateTimePicker
                              v-model="form.rwy_kerja[item.ptk_id].tgl_sk_kerja"
                              placeholder="== Pilih Tanggal =="
                              :config="dateConfig"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id].mapel_diajarkan"
                              placeholder="Mapel Diajarkan"
                            />
                          </td>
                          <td>
                            <AppTextField
                              v-model="form.rwy_kerja[item.ptk_id].tempat_kerja"
